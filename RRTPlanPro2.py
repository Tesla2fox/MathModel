...
# import dunbins
# from  dunbins import  dubins_3Dpath_planningF
...
if __name__ == '__main__':
    ...
    px, py, pz, ppsi, pgamma, clen, mode = db.dubins_3Dpath_planning(start_x, start_y, start_z, start_psi, start_gamma,
    ...
    # print(len(allPntLst))
    # print(allPntLst)
    gp = RRTPlan2(allPntLst , typeLst, lst_x, lst_y, lst_z,pnt_A, pnt_B , a1 ,a2 ,b1 ,b2 ,th)
